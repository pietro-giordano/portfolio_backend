                  ...
                  <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <form action="{{ route('admin.projects.store') }}" method="POST" enctype="multipart/form-data" class="pt-8 pb-20 md:px-2 lg:px-4">
                              ...
                              <div class="px-3 pb-3 lg:px-5 lg:pb-5">
                                    ...
                                    <input type="text" id="name" name="name" value="{{ old('name') }}" class="w-full md:w-1/2 text-sm mt-2 rounded-md shadow-sm border-0 ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md" placeholder="Inserire nome progetto..." required min="6" max="255">
                              </div>
                              ...
                              <div class="px-3 pb-3 lg:px-5 lg:pb-5">
                                    ...
                                    <input type="text" id="github-0" name="github[]" value="{{ old('github[0]') }}" class="w-full md:w-1/2 text-sm mt-2 rounded-md shadow-sm border-0 ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md" placeholder="Inserire link progetto..." min="20" max="255">
                                    <input type="text" id="github-1" name="github[]" value="{{ old('github[1]') }}" class="block w-full md:w-1/2 text-sm mt-2 rounded-md shadow-sm border-0 ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md" placeholder="Inserire secondo link se previsto..." min="20" max="255">
                              </div>
